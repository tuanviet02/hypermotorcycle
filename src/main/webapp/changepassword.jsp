            ...
            <section class="main-banner mv-wrap">
                <div data-image-src="images/background/demo_bg_1920x1680.png" class="mv-banner-style-1 mv-bg-overlay-dark overlay-0-85 mv-parallax">
                    <div class="page-name mv-caption-style-6">
                        <div class="container">
                            <div class="mv-title-style-9"><span class="main">Change Password</span><img src="images/icon/icon_line_polygon_line.png" alt="icon" class="line"/></div>
                        </div>
                    </div>
                </div>
            </section>
                                ...
                                <form method="post" class="changepassword">
                                    <div class="form-header">
                                        <div class="mv-title-style-13">
                                            <div class="text-main">Change your password</div>
                                        </div>
                                    </div>
                                    <!-- .form-header-->
                                    <div class="form-body">
                                        <div class="mv-form-group">
                                            <div class="mv-label"> <strong class="text-uppercase">Old Password</strong></div>
                                            <div class="mv-field">
                                                <input type="password" name="oldPass" class="mv-inputbox mv-inputbox-style-1"/>
                                            </div>
                                        </div>
                                        <div class="mv-form-group">
                                            <div class="mv-label"> <strong class="text-uppercase">New Password</strong></div>
                                            <div class="mv-field">
                                                <input type="password" id="newpass" name="newPass" placeholder="length >8 <32 must have uppercase letters and special characters" required name="newpass" minlength="8" maxlength="32" pattern="^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,32}$"  class="mv-inputbox mv-inputbox-style-1"/>
                                            </div>
                                        </div>
                                        <div class="mv-form-group">
                                            <div class="mv-label"> <strong class="text-uppercase">Confirm Password</strong></div>
                                            <div class="mv-field">
                                                <input type="password" name="rePass" class="mv-inputbox mv-inputbox-style-1"/>
                                            </div>
                                        </div>
                                        <div class="mv-form-group">
                                        ...
                                        <div class="mv-form-group submit-button mv-mt-30">
                                            <button type="submit" class="mv-btn mv-btn-style-5 btn-signup">Change</button>
                                        </div>
                                    </div>
                                    <!-- .form-body-->
                                </form>
