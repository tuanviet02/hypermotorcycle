                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-price" data-title="Price">
                                                <div class="price price-contain">
                                                    <ins><span class="price-amount"><span class="currencySymbol">VND</span>${cart.getProduct().getUnitPrice()}</span></ins>
                                                </div>
                                            </td>
                                            <td class="product-quantity" data-title="Quantity">
                                                <div class="quantity-box type1">
                                                    <a href="./EditQuantityCartItem?pid=${cart.getProduct().getProductId()}&newQuantity=${cart.getQuantity()-1}"><i class="fa-solid fa-minus"></i></a>
                                                    ${cart.getQuantity()}
                                                    <a href="./EditQuantityCartItem?pid=${cart.getProduct().getProductId()}&newQuantity=${cart.getQuantity()+1}"><i class="fa-solid fa-plus"></i></a>

                                                </div>
                                            </td>
                                            <td class="product-subtotal" data-title="Total">
                                                <div class="price price-contain">
                                                    <ins><span class="price-amount"><span class="currencySymbol">VND</span>${cart.getProduct().getUnitPrice()*cart.getQuantity()}</span></ins>
                                                </div>
                                            </td>
                                            <td class="product-subtotal" data-title="Total">
                                                <div class="action">
