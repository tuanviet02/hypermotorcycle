<%-- 
    Document   : register
    Created on : Sep 14, 2022, 1:56:38 PM
    Author     : huyen
--%>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-6 col-register">
              <div class="mv-form-style-1 mv-box-shadow-gray-1">
                <form method="POST" class="form-register" action="register">
                  <div class="form-header">
                    <div class="mv-title-style-13">
                  ...
                  <div class="form-body">
                    <div class="mv-form-group">
                      <div class="mv-label"> <strong class="text-uppercase">Email</strong></div>
                      <div class="mv-field">
                        <input type="email" id="email" name="email" type="email" required placeholder="Your email address" class="mv-inputbox mv-inputbox-style-1"/>
                      </div>
                    </div>
					
					<div class="form-body">
                    <div class="mv-form-group">
                      <div class="mv-label"> <strong class="text-uppercase">Firstname</strong></div>
                      <div class="mv-field">
                        <input id="fname" type="text" required name="fname" placeholder="Your first name" class="mv-inputbox mv-inputbox-style-1"/>
                      </div>
                    </div>
					
					<div class="form-body">
                    <div class="mv-form-group">
                      <div class="mv-label"> <strong class="text-uppercase">Lastname</strong></div>
                      <div class="mv-field">
                        <input id="lname" type="text" required name="lname" placeholder="Your last name" class="mv-inputbox mv-inputbox-style-1"/>
                      </div>
                    </div>
					
					<div class="form-body">
                    <div class="mv-form-group">
                      <div class="mv-label"> <strong class="text-uppercase">Phone</strong></div>
                      <div class="mv-field">
                        <input type="tel" id="phone" name="phone" pattern="[0-9]{10}" required placeholder="Your phone number" class="mv-inputbox mv-inputbox-style-1"/>
                      </div>
                    </div>
					
					 <div class="mv-form-group">
                      <div class="mv-label"> <strong class="text-uppercase">Gender</strong></div>
                      <div class="mv-field">
					  <form>
...
  						<label for="gender">Other</label>
                    ...
                    <div class="mv-form-group">
                      <div class="mv-label"> <strong class="text-uppercase">Password</strong></div>
                      <div class="mv-field">
                        <input type="password" id="password" type="password" required name="password" placeholder="Enter your password" minlength="8" maxlength="32" pattern="^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,32}$" class="mv-inputbox mv-inputbox-style-1"/>
                    ...
                    <div class="mv-form-group">
                      ...
                      <div class="mv-field">
                        <input type="password" id="cfpassword" type="password" required name="cfpassword" placeholder="Confirm your password" minlength="8" maxlength="32" pattern="^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,32}$" class="mv-inputbox mv-inputbox-style-1"/>
						<input type="checkbox" onclick="showCfPass()">Show Password
                      </div>
                    </div>
					
					
							<div class="mv-label"> <strong>Password must contain a-z, A-Z, 0-9, special character and have length from 8 to 32</strong></div>
							<div style="color: red">${requestScope.mess1}</div>
